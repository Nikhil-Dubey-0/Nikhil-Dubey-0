<!-- HEADER WAVE BANNER -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1a1b27,100:6C63FF&height=220&section=header&text=Nikhil%20Dubey&fontSize=55&fontColor=FFFFFF&fontAlignY=35&desc=ML%20%7C%20Deep%20Learning%20%7C%20Computer%20Vision%20%7C%20Generative%20AI&descSize=18&descColor=A78BFA&descAlignY=55&animation=fadeIn" width="100%"/>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/Nikhil-Dubey-0?tab=repositories">
...
Fun Facts:
  - 🔭 I build ML apps and deploy them with Streamlit
  - 🌱 Currently diving deep into Agentic AI & LLMs
  - 🎯 Goal → Contribute to cutting-edge AI research
  - ⚡ I turn data into intelligent decisions
```
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/LangGraph-0D1117?style=for-the-badge&logo=langchain&logoColor=6C63FF"/>
  ...
  <img src="https://img.shields.io/badge/RAG-A78BFA?style=for-the-badge&logoColor=white"/>
...
### 🎬 [Movie Recommendation System](https://github.com/Nikhil-Dubey-0/movie-app)
<p>
...
> Content-based movie recommender built on **5,000+ movies** using TF-IDF vectorization & cosine similarity ranking with popularity signals. Features an interactive Streamlit UI for real-time search & recommendations.

🔗 [**Live Demo**](https://movie-app-main.streamlit.app)

</td>
<td width="50%" valign="top">

### 🚗 [AI Traffic Monitoring System](https://github.com/Nikhil-Dubey-0/Traffic-Monitoring-System)
<p>
...
> Real-time traffic monitoring using **YOLOv8** for vehicle detection, motion tracking for speed estimation, congestion detection logic, and an interactive Streamlit dashboard for traffic analytics & visualization.

🔗 [**Live Demo**](https://traffic-monitoring-system.streamlit.app)
...
```text
🧠 Deepening knowledge in Deep Learning & Neural Architectures
